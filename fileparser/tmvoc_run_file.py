...
read_file.plotTime(['X3_L_toluene', 'X2_L_O2', 'X4_L_BENZENE'], 0, labels=['Toluene', 'Oxygen', 'Benzene'],singlePlot=True, format_of_date='year')
read_file2.plotTime(['X_toluen_L', 'X_O2_L', 'X_BENZEN_L', 'BIO1'], 0, labels=['Toluene', 'Oxygen', 'Benzene', 'Biomass'],singlePlot=True, format_of_date='day')
